...
from pynamodb.attributes import DESERIALIZE_CLASS_MAP, SERIALIZE_CLASS_MAP, SERIALIZE_KEY_MAP
from pynamodb.compat import getmembers_issubclass
from pynamodb.constants import ATTR_TYPE_MAP, BINARY, DEFAULT_ENCODING, BINARY_SET, STRING_SET, STRING, NUMBER, BOOLEAN, \
    NUMBER_SHORT, NUMBER_SET, DATETIME_FORMAT, NULL, MAP, MAP_SHORT, LIST
...
class AttributeContainer(object, metaclass=AttributeContainerMeta):
